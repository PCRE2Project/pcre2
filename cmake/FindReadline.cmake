...
if(READLINE_INCLUDE_DIR AND READLINE_LIBRARY)
  ...
  message(STATUS "XXX HAVE_READLINE_FUNC = ${HAVE_READLINE_FUNC}")

  if(NOT HAVE_READLINE_FUNC)
    message(STATUS "XXX in the inner if statement")
    foreach(
      lib
      tinfo
      curses
      ...
      message(STATUS "XXX NCURSES_LIBRARY_${lib} = ${NCURSES_LIBRARY_${lib}}")
      if(NCURSES_LIBRARY_${lib})
        message(STATUS "XXX in the innermost if statement (lib=${lib})")
        ...
        message(STATUS "XXX HAVE_READLINE_FUNC_${lib} = ${HAVE_READLINE_FUNC_${lib}}")
