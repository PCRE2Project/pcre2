...
mebibytes (units of 1024pass:[*]1024 bytes).
...
the use of (pass:[*]UTF) and (pass:[*]UCP) at the start of patterns. This command also forces
...
Invoking \N{Upass:[+]hh...} or \x{hh...} doesn't require the use of the `utf`
...
but when using \N{Upass:[+]hh...} with some invalid unicode characters they will
...
it is preferred to use \N{Upass:[+]hh...} when describing characters. When testing
...
[literal,subs=normal]
....
pass:[    ]allow_empty_class         set PCRE2_ALLOW_EMPTY_CLASS
pass:[    ]allow_lookaround_bsk      set PCRE2_EXTRA_ALLOW_LOOKAROUND_BSK
pass:[    ]allow_surrogate_escapes   set PCRE2_EXTRA_ALLOW_SURROGATE_ESCAPES
pass:[    ]alt_bsux                  set PCRE2_ALT_BSUX
pass:[    ]alt_circumflex            set PCRE2_ALT_CIRCUMFLEX
pass:[    ]alt_extended_class        set PCRE2_ALT_EXTENDED_CLASS
pass:[    ]alt_verbnames             set PCRE2_ALT_VERBNAMES
pass:[    ]anchored                  set PCRE2_ANCHORED
/a  ascii_all                 set all ASCII options
pass:[    ]ascii_bsd                 set PCRE2_EXTRA_ASCII_BSD
pass:[    ]ascii_bss                 set PCRE2_EXTRA_ASCII_BSS
pass:[    ]ascii_bsw                 set PCRE2_EXTRA_ASCII_BSW
pass:[    ]ascii_digit               set PCRE2_EXTRA_ASCII_DIGIT
pass:[    ]ascii_posix               set PCRE2_EXTRA_ASCII_POSIX
pass:[    ]auto_callout              set PCRE2_AUTO_CALLOUT
pass:[    ]bad_escape_is_literal     set PCRE2_EXTRA_BAD_ESCAPE_IS_LITERAL
/i  caseless                  set PCRE2_CASELESS
/r  caseless_restrict         set PCRE2_EXTRA_CASELESS_RESTRICT
pass:[    ]dollar_endonly            set PCRE2_DOLLAR_ENDONLY
/s  dotall                    set PCRE2_DOTALL
pass:[    ]dupnames                  set PCRE2_DUPNAMES
pass:[    ]endanchored               set PCRE2_ENDANCHORED
pass:[    ]escaped_cr_is_lf          set PCRE2_EXTRA_ESCAPED_CR_IS_LF
/x  extended                  set PCRE2_EXTENDED
/xx extended_more             set PCRE2_EXTENDED_MORE
pass:[    ]extra_alt_bsux            set PCRE2_EXTRA_ALT_BSUX
pass:[    ]firstline                 set PCRE2_FIRSTLINE
pass:[    ]literal                   set PCRE2_LITERAL
pass:[    ]match_line                set PCRE2_EXTRA_MATCH_LINE
pass:[    ]match_invalid_utf         set PCRE2_MATCH_INVALID_UTF
pass:[    ]match_unset_backref       set PCRE2_MATCH_UNSET_BACKREF
pass:[    ]match_word                set PCRE2_EXTRA_MATCH_WORD
/m  multiline                 set PCRE2_MULTILINE
pass:[    ]never_backslash_c         set PCRE2_NEVER_BACKSLASH_C
pass:[    ]never_callout             set PCRE2_EXTRA_NEVER_CALLOUT
pass:[    ]never_ucp                 set PCRE2_NEVER_UCP
pass:[    ]never_utf                 set PCRE2_NEVER_UTF
/n  no_auto_capture           set PCRE2_NO_AUTO_CAPTURE
pass:[    ]no_auto_possess           set PCRE2_NO_AUTO_POSSESS
pass:[    ]no_bs0                    set PCRE2_EXTRA_NO_BS0
pass:[    ]no_dotstar_anchor         set PCRE2_NO_DOTSTAR_ANCHOR
pass:[    ]no_start_optimize         set PCRE2_NO_START_OPTIMIZE
pass:[    ]no_utf_check              set PCRE2_NO_UTF_CHECK
pass:[    ]python_octal              set PCRE2_EXTRA_PYTHON_OCTAL
pass:[    ]turkish_casing            set PCRE2_EXTRA_TURKISH_CASING
pass:[    ]ucp                       set PCRE2_UCP
pass:[    ]ungreedy                  set PCRE2_UNGREEDY
pass:[    ]use_offset_limit          set PCRE2_USE_OFFSET_LIMIT
pass:[    ]utf                       set PCRE2_UTF
....
...
[literal,subs=normal]
....
pass:[    ]optimization_full      enable all optional optimizations
pass:[    ]optimization_none      disable all optional optimizations
pass:[    ]auto_possess           auto-possessify variable quantifiers
pass:[    ]auto_possess_off       don't auto-possessify variable quantifiers
pass:[    ]dotstar_anchor         anchor patterns starting with .*
pass:[    ]dotstar_anchor_off     don't anchor patterns starting with .*
pass:[    ]start_optimize         enable pre-scan of subject string
pass:[    ]start_optimize_off     disable pre-scan of subject string
....
...
[literal,subs=normal]
....
pass:[    ]aftertext                   show text after match
pass:[    ]allaftertext                show text after captures
pass:[    ]allcaptures                 show all captures
pass:[    ]allvector                   show the entire ovector
pass:[    ]allusedtext                 show all consulted text
pass:[    ]altglobal                   alternative global matching
/g  global                      global matching
pass:[    ]heapframes_size             show match data heapframes size
pass:[    ]jitstack=<n>                set size of JIT stack
pass:[    ]mark                        show mark values
pass:[    ]null_substitute_match_data  substitute with NULL match data
pass:[    ]replace=<str>               specify a replacement string
pass:[    ]startchar                   show starting character when relevant
pass:[    ]substitute_callout          use substitution callouts
pass:[    ]substitute_case_callout     use substitution case callouts
pass:[    ]substitute_extended         use PCRE2_SUBSTITUTE_EXTENDED
pass:[    ]substitute_literal          use PCRE2_SUBSTITUTE_LITERAL
pass:[    ]substitute_matched          use PCRE2_SUBSTITUTE_MATCHED
pass:[    ]substitute_overflow_length  use PCRE2_SUBSTITUTE_OVERFLOW_LENGTH
pass:[    ]substitute_replacement_only use PCRE2_SUBSTITUTE_REPLACEMENT_ONLY
pass:[    ]substitute_skip=<n>         skip substitution <n>
pass:[    ]substitute_stop=<n>         skip substitution <n> and following
pass:[    ]substitute_unknown_unset    use PCRE2_SUBSTITUTE_UNKNOWN_UNSET
pass:[    ]substitute_unset_empty      use PCRE2_SUBSTITUTE_UNSET_EMPTY
....
...
....
pass:[    ]anchored                   set PCRE2_ANCHORED
pass:[    ]copy_matched_subject       set PCRE2_COPY_MATCHED_SUBJECT
pass:[    ]endanchored                set PCRE2_ENDANCHORED
pass:[    ]dfa_restart                set PCRE2_DFA_RESTART
pass:[    ]dfa_shortest               set PCRE2_DFA_SHORTEST
pass:[    ]disable_recurseloop_check  set PCRE2_DISABLE_RECURSELOOP_CHECK
pass:[    ]no_jit                     set PCRE2_NO_JIT
pass:[    ]no_utf_check               set PCRE2_NO_UTF_CHECK
pass:[    ]notbol                     set PCRE2_NOTBOL
pass:[    ]notempty                   set PCRE2_NOTEMPTY
pass:[    ]notempty_atstart           set PCRE2_NOTEMPTY_ATSTART
pass:[    ]noteol                     set PCRE2_NOTEOL
pass:[    ]partial_hard (or ph)       set PCRE2_PARTIAL_HARD
pass:[    ]partial_soft (or ps)       set PCRE2_PARTIAL_SOFT
....
...
pass:[    ]allaftertext               show text after captures
pass:[    ]allcaptures                show all captures
pass:[    ]allusedtext                show all consulted text (non-JIT only)
pass:[    ]allvector                  show the entire ovector
pass:[    ]altglobal                  alternative global matching
pass:[    ]callout_capture            show captures at callout time
pass:[    ]callout_data=<n>           set a value to pass via callouts
pass:[    ]callout_error=<n>[:<m>]    control callout error
pass:[    ]callout_extra              show extra callout information
pass:[    ]callout_fail=<n>[:<m>]     control callout failure
pass:[    ]callout_no_where           do not show position of a callout
pass:[    ]callout_none               do not supply a callout function
pass:[    ]copy=<number or name>      copy captured substring
pass:[    ]depth_limit=<n>            set a depth limit
pass:[    ]dfa                        use `pcre2_dfa_match()`
pass:[    ]find_limits                find heap, match and depth limits
pass:[    ]find_limits_noheap         find match and depth limits
pass:[    ]get=<number or name>       extract captured substring
pass:[    ]getall                     extract all captured substrings
/g  global                     global matching
pass:[    ]heapframes_size            show match data heapframes size
pass:[    ]heap_limit=<n>             set a limit on heap memory (Kbytes)
pass:[    ]jitstack=<n>               set size of JIT stack
pass:[    ]mark                       show mark values
pass:[    ]match_limit=<n>            set a match limit
pass:[    ]memory                     show heap memory usage
pass:[    ]null_context               match with a NULL context
pass:[    ]null_replacement           substitute with NULL replacement
pass:[    ]null_subject               match with NULL subject
pass:[    ]null_substitute_match_data substitute with NULL match data
pass:[    ]offset=<n>                 set starting offset
pass:[    ]offset_limit=<n>           set offset limit
pass:[    ]ovector=<n>                set size of output vector
pass:[    ]recursion_limit=<n>        obsolete synonym for depth_limit
pass:[    ]replace=<str>              specify a replacement string
pass:[    ]startchar                  show startchar when relevant
pass:[    ]startoffset=<n>            same as offset=<n>
pass:[    ]substitute_callout         use substitution callouts
pass:[    ]substitute_case_callout    use substitution case callouts
pass:[    ]substitute_extended        use PCRE2_SUBSTITUTE_EXTENDED
pass:[    ]substitute_literal         use PCRE2_SUBSTITUTE_LITERAL
...
pass:[    ]substitute_overflow_length use PCRE2_SUBSTITUTE_OVERFLOW_LENGTH
pass:[    ]substitute_replacement_only use PCRE2_SUBSTITUTE_REPLACEMENT_ONLY
pass:[    ]substitute_skip=<n>        skip substitution number n
pass:[    ]substitute_stop=<n>        skip substitution number n and greater
pass:[    ]substitute_subject=<str>   specify a different subject for substitution
pass:[    ]substitute_unknown_unset   use PCRE2_SUBSTITUTE_UNKNOWN_UNSET
pass:[    ]substitute_unset_empty     use PCRE2_SUBSTITUTE_UNSET_EMPTY
pass:[    ]zero_terminate             pass the subject as zero-terminated
....
...
_start_offset_ argument to `pcre2_match()` or `pcre2_dfa_match()`
...
set to a value greater than zero the callout function returns pass:[+]1 for the match
...
such as (pass:[*]LIMIT_MATCH=...) within it. If such a setting is present and is
...
is followed by the rest of the subject string, identified by "0pass:[+]" like this:
...
If a pattern contains (pass:[*]MARK) items, an additional line is output whenever
...
for any match. If `no_auto_possess` is not used, the "apass:[+]" item is turned
into "apass:[+]pass:[+]", which reduces the number of backtracks.
