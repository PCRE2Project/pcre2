...
#error Static PCRE2 dependency did not define PCRE2_STATIC
#endif

#if defined(EXPECT_STATIC) && defined(PCRE2POSIX_SHARED)
#error Static PCRE2 POSIX dependency defined PCRE2POSIX_SHARED
#endif

#if defined(EXPECT_SHARED) && defined(PCRE2_STATIC)
#error Shared PCRE2 dependency defined PCRE2_STATIC
#endif

#if defined(EXPECT_SHARED) && !defined(PCRE2POSIX_SHARED)
#error Shared PCRE2 POSIX dependency did not define PCRE2POSIX_SHARED
#endif
